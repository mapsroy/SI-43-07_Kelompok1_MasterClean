...
<div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="col-md-12">
                        <a href="{{ url('home') }}" class="btn btn-primary">Back</a><br><br>
                    </div>
                <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <form  method="post" action="{{ url('pesan') }}/{{ $layanan->id }}">
                                                @csrf
                                            <input type="text" name="jumlah_pesan" class="form-control" required=""></td>
